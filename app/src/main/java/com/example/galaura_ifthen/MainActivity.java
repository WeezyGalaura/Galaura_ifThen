package com.example.galaura_ifthen;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtLore.setText("Sunflower is better than roses");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.btnDecision1:
                txtDecision.setText(" I think sunflower is better than roses");
                break;

            case R.id.btnDecision2:
                txtDecision.setText("I think roses is better than sunflower");
                break;
        }
    }
}
